...
// Common functions for all pages
    ...
    function getSplashHeader() {
        ...
        headerHtml += "<tr class='sign_in'><td><p>Yes, I'd like to create a free account</p></td><td><a href='" + SizeMe.contextAddress + "/?mode=signup' target='_blank' class='a_button' id='sizeme_btn_sign_up'>Sign up</a></td></tr>";
    ...
    function getProductSplash() {
		...
		splashHtml += "<p>Unsure about the right size?<br>Try <b>SizeMe</b> - it's 100 % free!</p>";
		splashHtml += "<a href='" + SizeMe.contextAddress + "' target='_blank' id='sizeme_product_page_link'></a>";
