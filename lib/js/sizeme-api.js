...
(function() {
  ...
  SizeMe = (function() {
     ...
     */
    var _authToken, _facepalm, addMessageListener, createCORSRequest, createFitResponse, defaultErrorCallback, removeMessageListener, sizemeTrackerInit;
    ...
    SizeMe.trackEvent = function(event) {
      if (!sizemeTrackerInit) {
        if (window.ga != null) {
          ...
          this.trackEvent = function(e) {
            e.hitType = "event";
            return ga("sizemeTracker.send", e);
          };
